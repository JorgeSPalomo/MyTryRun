package com.syntax.cucumverproject.test.stepDefinitions;
...
public void i_enter_username_and_password() throws Throwable {
    driver.findElement(By.xpath("//input[@placeholder='Username']")).sendKeys("JorgeSPalomo	");
    driver.findElement(By.xpath("//input[@placeholder='Password']")).sendKeys("4101989Jp");
...
public void i_enter_username_and_invalid_password() throws Throwable {
   
}

@Then("^I sitll see sign up link$")
public void i_sitll_see_sign_up_link() throws Throwable {
